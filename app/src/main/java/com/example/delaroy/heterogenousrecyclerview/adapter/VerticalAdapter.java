...
public class VerticalAdapter extends RecyclerView.Adapter<VerticalAdapter.MyViewHolder> {
    ...
    public ArrayList<SingleVertical> getData() {
        return data;
    }

    public void setData(ArrayList<SingleVertical> data) {
        this.data = data;
    }

    public void setAddData(ArrayList<SingleVertical> data) {
        for (SingleVertical dataBaru:data){
